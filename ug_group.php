...
$nonAdminTablesArr[] = "global_config";
...
$wGroupTableName = $ug_connection->addTableWrappers( "gestionentidad_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "gestionentidad_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "gestionentidad_ugrights" );
