...
function InitLookupLinks()
{
	...
	$lookupTableLinks = array();
		...
		if( !isset( $lookupTableLinks["tparam_estados"]["global_users.active"] )) {
			$lookupTableLinks["tparam_estados"]["global_users.active"] = array();
		}
		$lookupTableLinks["tparam_estados"]["global_users.active"]["edit"] = array("table" => "global_users", "field" => "active", "page" => "edit");
		if( !isset( $lookupTableLinks["tparam_estados"] ) ) {
			$lookupTableLinks["tparam_estados"] = array();
		}
		...
		if( !isset( $lookupTableLinks["tparam_estados"]["global_users_contratistas.active"] )) {
			$lookupTableLinks["tparam_estados"]["global_users_contratistas.active"] = array();
		}
		$lookupTableLinks["tparam_estados"]["global_users_contratistas.active"]["edit"] = array("table" => "global_users_contratistas", "field" => "active", "page" => "edit");
		if( !isset( $lookupTableLinks["dependencia"] ) ) {
			$lookupTableLinks["dependencia"] = array();
		}
		...
		if( !isset( $lookupTableLinks["tparam_estado"]["tparam_uej.ctrl"] )) {
			$lookupTableLinks["tparam_estado"]["tparam_uej.ctrl"] = array();
		}
		$lookupTableLinks["tparam_estado"]["tparam_uej.ctrl"]["edit"] = array("table" => "tparam_uej", "field" => "ctrl", "page" => "edit");
}
