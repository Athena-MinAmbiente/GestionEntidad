...
class tDAL
{
	...
	var $tbldbsep_at_127_0_0_1__tparam_estado;
	var $tbldbsep_at_127_0_0_1__tparam_uej;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "gestionentidad_audit", "varname" => "dbusers_at_localhost__gestionentidad_audit", "altvarname" => "gestionentidad_audit", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "global_config", "varname" => "dbusers_at_localhost__global_config", "altvarname" => "global_config", "connId" => "dbusers_at_localhost", "schema" => "", "connName" => "dbusers at 127.0.0.1");
		...
		$this->lstTables[] = array("name" => "tparam_estado", "varname" => "dbsep_at_127_0_0_1__tparam_estado", "altvarname" => "tparam_estado", "connId" => "dbsep_at_127_0_0_1", "schema" => "", "connName" => "dbsep at 127.0.0.1");
		$this->lstTables[] = array("name" => "tparam_uej", "varname" => "dbsep_at_127_0_0_1__tparam_uej", "altvarname" => "tparam_uej", "connId" => "dbsep_at_127_0_0_1", "schema" => "", "connName" => "dbsep at 127.0.0.1");
	}
